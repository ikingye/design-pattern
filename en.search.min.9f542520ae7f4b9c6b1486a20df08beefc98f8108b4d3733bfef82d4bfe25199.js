...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/design-pattern-note/flexsearch.min.js');loadScript('/design-pattern-note/en.search-data.min.c7d1ee59dda56a0d8cc34ed81388a1bc4990a32e6ec41a2567dfb996a03677d2.js',function(){input.required=false;search();});}
