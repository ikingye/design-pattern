...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/design-pattern/flexsearch.min.js');loadScript('/design-pattern/en.search-data.min.87a70acd0a74c663d4e36bec0b6d8464ebde8556c4ab3a34f66e97d8eb81bba1.js',function(){input.required=false;search();});}
